    ...
    <form @submit.prevent="salvarAvaliacao" class="space-y-8">
      ...
      <fieldset class="form-section">
        ...
        <div class="form-grid-1-cols">
          ...
          <div class="form-group"><label class="form-label">Cicatriz Umbilical</label><div class="radio-group"><label><input type="radio" v-model="ficha.anterior_cicatriz_umbilical" value="Alinhada" class="form-radio"> Alinhada</label><label><input type="radio" v-model="ficha.anterior_cicatriz_umbilical" value="Desvio à direita" class="form-radio"> Desvio à Direita</label><label><input type="radio" v-model="ficha.anterior_cicatriz_umbilical" value="Desvio à esquerda" class="form-radio"> Desvio à esquerda</label></div></div>
          <div class="form-group"><label class="form-label">Altura das C. Ilíacas</label><div class="radio-group"><label><input type="radio" v-model="ficha.anterior_iliacas_altura" value="Simétricas" class="form-radio"> Simétricos</label><label><input type="radio" v-model="ficha.anterior_iliacas_altura" value="Direito + alta" class="form-radio"> Direito + alta</label><label><input type="radio" v-model="ficha.anterior_iliacas_altura" value="Esquerda + alto" class="form-radio"> Esquerda + alto</label></div></div>
      ...
      <fieldset class="form-section">
        ...
        <div class="form-grid-1-cols">
          ...
          <div class="form-group"><label class="form-label">Pregas Glúteas</label><div class="radio-group"><label><input type="radio" v-model="ficha.posterior_pregas_gluteas" value="Simétricas" class="form-radio"> Simétricos</label><label><input type="radio" v-model="ficha.posterior_pregas_gluteas" value="Direito + alto" class="form-radio"> Direito + alto</label><label><input type="radio" v-model="ficha.posterior_pregas_gluteas" value="Esquerdo + alto" class="form-radio"> Esquerdo + alto</label><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="+ profundo à direita" class="form-radio"> + profundo à direita</label><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="+ profundo à esquerda" class="form-radio"> + profundo à esquerda</label><label></label></div></div>
          <div class="form-group"><label class="form-label">Pregas Poplíteas</label><div class="radio-group"><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="Simétricas" class="form-radio"> Simétricos</label><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="Direito + alto" class="form-radio"> Direito + alto</label><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="Esquerdo + alto" class="form-radio"> Esquerdo + alto</label><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="+ profundo à direita" class="form-radio"> + profundo à direita</label><label><input type="radio" v-model="ficha.posterior_pregas_popliteas" value="+ profundo à esquerda" class="form-radio"> + profundo à esquerda</label><label></label></div></div>
      ...
      <fieldset class="form-section">
        ...
        <div class="form-grid-1-cols">
            ...
            <div class="form-group"><label class="form-label">Abdômen</label><div class="radio-group"><label><input type="radio" v-model="ficha.lateral_abdomen" value="Protuso" class="form-radio"> Protuso</label><label><input type="radio" v-model="ficha.lateral_abdomen" value="Ptose" class="form-radio"> Ptose</label></div></div>
            ...
            <div class="form-group"><label class="form-label">Pelve</label><div class="radio-group"><label><input type="radio" v-model="ficha.lateral_pelve" value="Normal" class="form-radio"> Normal</label><label><input type="radio" v-model="ficha.lateral_pelve" value="Antevertida" class="form-radio"> Antevertida</label><label><input type="radio" v-model="ficha.lateral_pelve" value="Retrovertida" class="form-radio"> Retrovertida</label></div></div>
            <div class="form-group"><label class="form-label">Quadril</label><div class="radio-group"><label><input type="radio" v-model="ficha.lateral_quadril" value="Normal" class="form-radio"> Normal</label><label><input type="radio" v-model="ficha.lateral_quadril" value="Fletido" class="form-radio"> Fletido</label></div></div>
            <div class="form-group"><label class="form-label">Joelho</label><div class="radio-group"><label><input type="radio" v-model="ficha.lateral_joelho" value="Normal" class="form-radio"> Normal</label><label><input type="radio" v-model="ficha.lateral_joelho" value="Fletido" class="form-radio"> Fletido</label></div></div>
        </div>
      </fieldset>
...
const salvarAvaliacao = async () => {
  ...
  Object.keys(ficha).forEach(key => {
    // Ignora 'id' e campos nulos/objetos complexos, envia string vazia se null
  ...
  // --- CORREÇÃO DO UPLOAD ---
  if (selectedFile.value) {
    // IMPORTANTE: O nome aqui deve ser 'anexo' para bater com o Controller
    dataToSubmit.append('anexo', selectedFile.value);
  }
  else if (ficha.caminho_anexo === null && ficha.id) {
      // Flag para avisar o controller para deletar o arquivo antigo
  ...
  try {
    let response;
    if (ficha.id) {
        // Laravel exige _method: PUT para FormData com arquivos em updates
    ...
    // Atualiza estado local com o caminho retornado
    ...
    setTimeout(() => {
     ...
     if (error.response && error.response.data.errors) {
       ...
       errorMessage.value = `Erro: ${validationErrors[firstErrorKey][0]}`;
     } else {
