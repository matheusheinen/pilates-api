<template>
  <div class="space-y-6 pb-24">
    ...
    <div class="flex justify-between items-center px-2 pt-2">
      <div>
        <h2 class="text-xl font-bold text-white leading-tight">Minha Agenda</h2>
        <p class="text-xs text-gray-500">Próximas aulas</p>
      </div>
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-2 bg-[#181818]">
                ...
                <div v-else-if="vagasDisponiveis.length === 0" class="text-center py-10 px-4">
                    ...
                    <p class="text-xs text-gray-500">
                        Não há horários disponíveis para reagendamento na semana da sua aula original. Entre em contato com o estúdio.
                    </p>
                </div>
...
// --- HELPERS ---
const temAulaNoDia = (iso) => aulas.value.some(aula => aula.start && aula.start.startsWith(iso));
